...
export function DiffViewer({ planId }) {
    ...
    if (tasksWithDiff.length === 0) {
        return (_jsx("div", { className: "flex h-96 items-center justify-center rounded-xl border border-border/50 bg-card font-mono text-xs tracking-widest text-muted-foreground", children: "\u25C7 NO TASKS IN THIS PLAN" }));
    }
    return (_jsxs("div", { className: "overflow-hidden rounded-xl border border-border/50 bg-card shadow-card", children: [_jsxs("div", { className: "flex items-center justify-between border-b border-border/50 bg-muted/30 px-4 py-2.5", children: [_jsx("span", { className: "text-xs font-medium uppercase tracking-wider text-muted-foreground", children: "Diff \u00B7 Monaco" }), _jsxs("span", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: [tasksWithDiff.length, " TASK", tasksWithDiff.length !== 1 ? "S" : ""] })] }), _jsxs("div", { className: "grid grid-cols-[260px_1fr]", children: [_jsxs("div", { className: "border-r border-border/50 bg-muted/10", children: [_jsx("div", { className: "border-b border-border/50 bg-muted/30 px-4 py-2 text-xs font-medium uppercase tracking-wider text-muted-foreground", children: "Tasks" }), _jsx("div", { className: "max-h-[600px] overflow-auto", children: tasksWithDiff.map((t) => {
                                    ...
                                    return (_jsxs("button", { onClick: () => setSelectedTaskId(t.task_id), className: [
                                            ...
                                            active
                                                ...
                                                : "hover:bg-muted/40",
                                        ].join(" "), children: [_jsxs("span", { className: `font-mono text-[10px] ${active ? "text-indigo-500" : "text-muted-foreground/70"}`, children: ["#", String(t.task_index).padStart(2, "0")] }), _jsx("span", { className: "truncate text-[12px] font-medium", children: t.title || t.task_id.slice(0, 8) })] }, t.task_id));
                                }) })] }), _jsxs("div", { className: "flex flex-col", children: [_jsxs("div", { className: "flex items-center justify-between border-b border-border/50 bg-muted/20 px-4 py-2", children: [_jsx("span", { className: "truncate font-mono text-[11px] text-muted-foreground", children: (_d = (_c = activeTask === null || activeTask === void 0 ? void 0 : activeTask.prompt) === null || _c === void 0 ? void 0 : _c.slice(0, 80)) !== null && _d !== void 0 ? _d : "—" }), !(activeTask === null || activeTask === void 0 ? void 0 : activeTask.diff_summary) && (_jsx("span", { className: "ml-2 shrink-0 font-mono text-[10px] tracking-widest text-muted-foreground/70", children: "\u25C7 NO DIFF" }))] }), _jsx("div", { style: { height: 560 }, children: (activeTask === null || activeTask === void 0 ? void 0 : activeTask.diff_summary) ? (_jsx(MonacoDiffEditor, { height: "100%", original: parsed.original, modified: parsed.modified, language: parsed.language, theme: "vs-dark", options: {
                                        readOnly: true,
                                    ...
                                    } })) : (_jsx("div", { className: "flex h-full items-center justify-center font-mono text-xs tracking-widest text-muted-foreground/70", children: "\u25C7 THIS TASK HAS NO DIFF SUMMARY" })) })] })] })] }));
}
