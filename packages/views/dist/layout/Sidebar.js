...
export function Sidebar({ open, onClose }) {
    ...
    return (_jsxs(_Fragment, { children: [open && (_jsx("div", { className: "fixed inset-0 z-40 bg-black/50 lg:hidden", onClick: onClose })), _jsxs("aside", { className: cn("fixed inset-y-0 left-0 z-50 flex w-56 shrink-0 flex-col border-r bg-card transition-transform duration-200 lg:static lg:translate-x-0", open ? "translate-x-0" : "-translate-x-full"), children: [_jsxs("div", { className: "flex h-14 items-center gap-2 border-b px-4", children: [_jsx("span", { className: "text-xl", children: "\uD83E\uDD16" }), _jsx("span", { className: "text-base font-bold tracking-tight", children: "Tide" })] }), _jsx("nav", { className: "flex-1 space-y-1 overflow-y-auto p-3", children: NAV_ITEMS.map((item) => (_jsxs(Link, { href: item.href, onClick: onClose, className: cn("flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors", isActive(pathname, item.href)
