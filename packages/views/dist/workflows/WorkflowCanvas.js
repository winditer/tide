...
function CanvasInner({ definition, nodeRuns, readOnly, onChange, onSave, onRun, isSaving, isRunning, toolbarExtra, subtitle, }) {
    ...
    const emitChange = useCallback((nextNodes, nextEdges) => {
        queueMicrotask(() => {
            var _a;
            (_a = onChangeRef.current) === null || _a === void 0 ? void 0 : _a.call(onChangeRef, flowToDef(nextNodes, nextEdges));
        });
    }, []);
    ...
    const handleAddNode = useCallback((type, position) => {
        ...
        const newNode = {
            id,
            type,
            position: position !== null && position !== void 0 ? position : { x: 240, y: 80 + nodes.length * 40 },
    ...
    return (_jsxs("div", { className: "flex h-full w-full overflow-hidden border-2 border-zinc-900 bg-white", children: [!readOnly && _jsx(NodePalette, { onAddNode: (t) => handleAddNode(t) }), _jsxs("div", { className: "relative flex min-w-0 flex-1 flex-col", children: [_jsxs("div", { className: "flex items-center gap-2 border-b-2 border-zinc-900 bg-zinc-950 px-4 py-2 text-white", children: [_jsx("span", { className: "inline-block h-2 w-2 bg-emerald-400" }), _jsxs("span", { className: "font-mono text-[11px] tracking-[0.3em]", children: ["\u25F3 WORKFLOW", readOnly ? " · RUN" : " · EDIT"] }), subtitle && (_jsxs("span", { className: "ml-2 truncate font-mono text-[10px] tracking-widest text-zinc-400", children: ["/ ", subtitle] })), _jsxs("div", { className: "ml-auto flex items-center gap-2", children: [!readOnly && onSave && (_jsx(Button, { size: "sm", variant: "outline", disabled: isSaving, onClick: () => onSave(flowToDef(nodes, edges)), className: "!border-white !bg-transparent !text-white hover:!bg-white hover:!text-zinc-900", children: isSaving ? "保存中…" : "💾 保存" })), onRun && (_jsx(Button, { size: "sm", disabled: isRunning, onClick: onRun, className: "!bg-emerald-500 !text-white hover:!bg-emerald-400", children: isRunning ? "运行中…" : "▶ 运行" })), toolbarExtra] })] }), _jsxs("div", { ref: wrapperRef, className: "relative flex-1 bg-[radial-gradient(circle_at_1px_1px,rgba(24,24,27,0.08)_1px,transparent_0)] bg-[length:18px_18px]", onDrop: onDrop, onDragOver: onDragOver, children: [_jsxs(ReactFlow, { nodes: nodes, edges: edges, nodeTypes: workflowNodeTypes, onNodesChange: onNodesChange, onEdgesChange: onEdgesChange, onConnect: onConnect, onNodeClick: handleNodeClick, onPaneClick: () => setSelectedId(null), fitView: true, fitViewOptions: { padding: 0.25 }, proOptions: { hideAttribution: true }, minZoom: 0.2, maxZoom: 1.6, nodesDraggable: !readOnly, nodesConnectable: !readOnly, elementsSelectable: true, deleteKeyCode: readOnly ? null : ["Backspace", "Delete"], children: [_jsx(Background, { variant: BackgroundVariant.Dots, gap: 20, size: 1.2, color: "rgba(24,24,27,0.18)" }), _jsx(Controls, { showInteractive: false, className: "!border !border-zinc-900 !bg-white !shadow-[3px_3px_0_0_rgba(24,24,27,0.92)]" }), _jsx(MiniMap, { zoomable: true, pannable: true, nodeStrokeWidth: 3, nodeColor: (n) => {
                                            var _a, _b, _c;
                                        ...
                                        }, className: "!border !border-zinc-900 !bg-white !shadow-[3px_3px_0_0_rgba(24,24,27,0.92)]" })] }), nodes.length === 0 && (_jsx("div", { className: "pointer-events-none absolute inset-0 flex items-center justify-center", children: _jsxs("div", { className: "border-2 border-dashed border-zinc-400 bg-white px-8 py-6 text-center shadow-[6px_6px_0_0_rgba(24,24,27,0.92)]", children: [_jsx("div", { className: "font-mono text-[11px] tracking-[0.3em] text-zinc-700", children: "\u25C7 EMPTY CANVAS" }), _jsx("div", { className: "mt-2 text-xs text-zinc-500", children: "\u4ECE\u5DE6\u4FA7\u62D6\u5165\u8282\u70B9\u5F00\u59CB\u6784\u5EFA\u5DE5\u4F5C\u6D41" })] }) }))] })] }), _jsx(PropertyPanel, { node: selectedNode, readOnly: readOnly, onUpdate: handleUpdateNodeData, onDelete: handleDeleteNode })] }));
}
