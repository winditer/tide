        ...
        return (
          <div key={file.path}>
            ...
            >
              ...
              <FileText className="h-4 w-4 flex-shrink-0 text-zinc-500 dark:text-zinc-400" />
              <span className="font-mono text-xs text-zinc-800 dark:text-zinc-200 truncate flex-1 min-w-0">
                {file.path}
              </span>
              ...
              <div className="bg-zinc-50/50 dark:bg-zinc-800/30 border-t border-zinc-100 dark:border-zinc-700/30 px-4 py-2">
                <div className="ml-8 space-y-1">
                  {file.commits.map((c) => (
                    ...
                    >
                      <GitCommitIcon className="h-3.5 w-3.5 text-blue-500 dark:text-blue-400 flex-shrink-0" />
