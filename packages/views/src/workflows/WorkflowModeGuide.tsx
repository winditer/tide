...
import { WORKFLOW_MODE_GUIDE } from "./workflow-mode-guide";
...
export function WorkflowModeGuide() {
  ...
  const blocks = parseMarkdown(WORKFLOW_MODE_GUIDE);
