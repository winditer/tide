...
import { REMOTE_AGENTS_GUIDE } from "./remote-agents-guide";
...
export function RemoteAgentGuide() {
  ...
  const blocks = parseMarkdown(REMOTE_AGENTS_GUIDE);
