...
Lark2Agent 是一个将飞书/Lark 群聊消息转换为 Codex、Claude Code 等 Agent CLI 任务的强大工具。它能够：
...
subgraph "项目根目录"
A[README.md] --> B[主文档说明]
C[lark2agent_ws.py] --> D[核心 WebSocket 服务器]
...
Q[.lark2agent_state.json] --> R[运行状态文件]
end
```

**图表来源**
- [README.md:1-517](file://README.md#L1-L517)
- [lark2agent_ws.py:1-8589](file://lark2agent_ws.py#L1-L8589)
...
LARK2AGENT_WELCOME_MESSAGE=I'm Lark2Agent, a lightweight multi-agent bridge for Lark.
STATUS_INTERVAL_SECONDS=0
LARK2AGENT_SHOW_ARCHIVED=0
```
...
**图表来源**
- [lark2agent_ws.py:626-800](file://lark2agent_ws.py#L626-L800)

**章节来源**
- [lark2agent_ws.py:173-800](file://lark2agent_ws.py#L173-L800)
...
**图表来源**
- [lark2agent_ws.py:1-30](file://lark2agent_ws.py#L1-L30)
...
**图表来源**
- [lark2agent_ws.py:34-151](file://lark2agent_ws.py#L34-L151)

**章节来源**
- [lark2agent_ws.py:1-151](file://lark2agent_ws.py#L1-L151)
...
### 状态持久化
- 本地运行状态文件：`.lark2agent_state.json`
- 附件下载目录：`.lark2agent/attachments`
...
1. 检查网络连接
2. 验证 Lark 应用配置是否正确
3. 查看日志文件：`tail -f lark2agent_ws.log`
...
Lark2Agent 为飞书/Lark 用户提供了强大的 Agent CLI 集成解决方案。通过本文档的快速开始指南，您应该能够：
...
1. **启动验证**：查看控制台输出包含 "Lark2Agent WebSocket 启动成功"
2. **功能测试**：在 Lark 群聊中发送 `/status` 指令
3. **日志检查**：查看 `lark2agent_ws.log` 文件中的错误信息
