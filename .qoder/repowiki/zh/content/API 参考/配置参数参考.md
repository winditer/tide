...
## 简介
本文件为 Lark2Agent 的完整配置参数参考，覆盖 Lark 平台集成、Agent CLI 集成、运行时参数、访问控制、卡片与消息、审批策略、状态持久化、macOS 保活等全部配置项。每项均给出用途说明、数据类型、默认值、取值范围、典型取值、使用场景、配置示例与注意事项，并总结配置间的依赖关系与约束条件。
...
```mermaid
graph TB
A["lark2agent_ws.py<br/>主程序与配置加载"] --> B[".env<br/>.env.example 加载"]
...
- [lark2agent_ws.py:56-60](file://lark2agent_ws.py#L56-L60)
...
- [lark2agent_ws.py:62-65](file://lark2agent_ws.py#L62-L65)
- [lark2agent_ws.py:74-98](file://lark2agent_ws.py#L74-L98)
...
- [lark2agent_ws.py:66-73](file://lark2agent_ws.py#L66-L73)
- [lark2agent_ws.py:85-91](file://lark2agent_ws.py#L85-L91)
- [lark2agent_ws.py:539-569](file://lark2agent_ws.py#L539-L569)
...
- PLAN_WORKTREE_ROOT
  ...
  - 默认值：空
  - 取值范围：有效路径或空
  - 用途：自定义 worktree 根目录；为空时使用当前仓库的 .lark2agent/worktrees
...
- [lark2agent_ws.py:118-124](file://lark2agent_ws.py#L118-L124)
...
- LARK2AGENT_WELCOME_MESSAGE
  ...
  - 示例：LARK2AGENT_WELCOME_MESSAGE=欢迎使用 Lark2Agent
...
- [lark2agent_ws.py:114-151](file://lark2agent_ws.py#L114-L151)
