...
Tide 是一个轻量级的多代理桥接系统，将飞书/Lark 群聊消息与多种 AI Agent CLI 工具（Codex、Claude Code、Qoder CLI）无缝连接。该系统通过 WebSocket 实时接收 Lark 事件，解析用户指令，管理任务执行流程，并通过交互式卡片实时反馈执行状态。
...
**图表来源**
- [tide_ws.py:7684-7718](file://tide_ws.py#L7684-L7718)
- [tide_ws.py:2968-3015](file://tide_ws.py#L2968-L3015)
...
- [tide_ws.py:4704-4805](file://tide_ws.py#L4704-L4805)

**章节来源**
- [tide_ws.py:3423-4026](file://tide_ws.py#L3423-L4026)
...
**图表来源**
- [tide_ws.py:4342-4348](file://tide_ws.py#L4342-L4348)
...
**图表来源**
- [tide_ws.py:4275-4322](file://tide_ws.py#L4275-L4322)
- [tide_ws.py:5606-5648](file://tide_ws.py#L5606-L5648)

**章节来源**
- [tide_ws.py:4325-5688](file://tide_ws.py#L4325-L5688)
...
**图表来源**
- [tide_ws.py:3346-3364](file://tide_ws.py#L3346-L3364)
- [tide_ws.py:6759-6824](file://tide_ws.py#L6759-L6824)
...
- [tide_ws.py:2074-2096](file://tide_ws.py#L2074-L2096)

**章节来源**
- [tide_ws.py:3277-3364](file://tide_ws.py#L3277-L3364)
...
- [tide_ws.py:2665-2718](file://tide_ws.py#L2665-L2718)
...
**章节来源**
- [tide_ws.py:2000-2266](file://tide_ws.py#L2000-L2266)
...
Tide 通过精心设计的架构和丰富的功能特性，成功实现了飞书与多种 AI Agent CLI 的深度集成。其核心优势包括：
