...
Lark2Agent 是一个将飞书/Lark 群聊消息转换为 Codex、Claude Code 等 Agent CLI 任务的系统。本文档专注于分析代码中的扩展点，特别是如何添加新的 Agent CLI 集成、扩展审批策略和定制附件处理。
...
graph TB
subgraph "核心模块"
A[lark2agent_ws.py] --> B[AgentAdapter 基类]
A --> C[Agent 适配器集合]
A --> D[扩展点定义]
end
subgraph "扩展点"
...
**图表来源**
- [lark2agent_ws.py:312-340](file://lark2agent_ws.py#L312-L340)
...
**图表来源**
- [lark2agent_ws.py:276-284](file://lark2agent_ws.py#L276-L284)
- [lark2agent_ws.py:1359-1599](file://lark2agent_ws.py#L1359-L1599)
...
- [lark2agent_ws.py:3982-4005](file://lark2agent_ws.py#L3982-L4005)
...
| 环境变量 | 默认值 | 描述 |
|----------|--------|------|
| `LARK_ATTACHMENTS_DIR` | `.lark2agent/attachments` | 附件存储目录 |
| `LARK_ATTACHMENT_MAX_BYTES` | `52428800` | 单个附件最大字节数 |
| `LARK_PENDING_ATTACHMENT_TTL_SECONDS` | `900` | 附件暂存超时时间 |

**章节来源**
- [lark2agent_ws.py:1449-1539](file://lark2agent_ws.py#L1449-L1539)
- [lark2agent_ws.py:110-117](file://lark2agent_ws.py#L110-L117)
...
Lark2Agent 通过精心设计的扩展点架构，为 Agent CLI 集成、审批策略扩展和附件处理定制提供了强大的支持。系统采用抽象基类、数据类和配置驱动的方式，确保了扩展的安全性和可维护性。
...
通过遵循这些原则和实践，开发者可以安全地扩展 Lark2Agent 的功能，满足各种复杂的集成需求。