...
## 简介
本文件围绕 Lark2Agent 的性能监控指标体系进行系统化梳理，聚焦于任务执行时间统计（启动延迟、执行时长分布、完成率）、内存与 GC、CPU 占有率、网络 I/O（WebSocket 连接与消息吞吐）、关键性能指标（并发度、响应时间、错误率、资源利用率），并给出性能基线、阈值与回归检测建议，以及与日志分析、性能分析器及第三方监控系统的集成思路。
...
## 架构总览
Lark2Agent 通过 Lark 事件订阅接入消息，基于事件处理器解析指令，创建任务并启动 Agent 子进程；任务执行过程中持续更新卡片，记录会话日志；Plan 模式下并行调度多个子任务，汇总状态与输出。
...
- [lark2agent_ws.py:2400-2437](file://lark2agent_ws.py#L2400-L2437)
- [lark2agent_ws.py:4376-4383](file://lark2agent_ws.py#L4376-L4383)
...
章节来源
- [lark2agent_ws.py:101-151](file://lark2agent_ws.py#L101-L151)
...
章节来源
- [lark2agent_ws.py:393-406](file://lark2agent_ws.py#L393-L406)
- [lark2agent_ws.py:1642-1652](file://lark2agent_ws.py#L1642-L1652)
...
章节来源
- [lark2agent_ws.py:107-124](file://lark2agent_ws.py#L107-L124)
- [lark2agent_ws.py:2268-2287](file://lark2agent_ws.py#L2268-L2287)
- [lark2agent_ws.py:7237-7249](file://lark2agent_ws.py#L7237-L7249)
...
- [lark2agent_ws.py:173-396](file://lark2agent_ws.py#L173-L396)
- [lark2agent_ws.py:626-801](file://lark2agent_ws.py#L626-L801)
- [lark2agent_ws.py:371-386](file://lark2agent_ws.py#L371-L386)
...
章节来源
- [lark2agent_ws.py:78-91](file://lark2agent_ws.py#L78-L91)
- [lark2agent_ws.py:107-124](file://lark2agent_ws.py#L107-L124)
...
- [lark2agent_ws.py:6516-6534](file://lark2agent_ws.py#L6516-L6534)
- [lark2agent_ws.py:1471-1539](file://lark2agent_ws.py#L1471-L1539)
- [lark2agent_ws.py:1677-1770](file://lark2agent_ws.py#L1677-L1770)

## 结论
Lark2Agent 已具备完善的任务生命周期与卡片可观测性，能够支撑任务执行时间统计、完成率与会话耗时等关键指标。结合系统层内存/CPU/网络监控与合理的并发/超时/输出控制策略，可形成稳定可靠的性能监控体系。建议在生产环境中引入第三方监控平台采集系统指标与日志，配合性能分析器进行热点定位与回归检测。
