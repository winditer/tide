...
## 项目结构
Tide 的状态同步能力集中在主程序文件中，涉及会话索引、状态持久化、卡片构建与更新、并发锁与轮询线程等模块。
...
- 状态持久化
  - .tide_state.json：存储已知聊天、运行态、计划任务、消息引用等
...
章节来源
- [tide_ws.py:286-310](file://tide_ws.py#L286-L310)
...
- [tide_ws.py:3663-3732](file://tide_ws.py#L3663-L3732)

## 架构总览
Tide 通过后台轮询线程监控 Codex/Claude/Qoder 的会话文件，解析事件并更新桌面同步卡片。状态持久化贯穿于运行态保存、计划任务恢复与消息引用记录。
...
图示来源
- [tide_ws.py:7161-7234](file://tide_ws.py#L7161-L7234)
- [tide_ws.py:7140-7158](file://tide_ws.py#L7140-L7158)
- [tide_ws.py:4206-4249](file://tide_ws.py#L4206-L4249)
- [tide_ws.py:3663-3732](file://tide_ws.py#L3663-L3732)
...
图示来源
- [tide_ws.py:4176-4203](file://tide_ws.py#L4176-L4203)
- [tide_ws.py:4206-4249](file://tide_ws.py#L4206-L4249)
- [tide_ws.py:3663-3732](file://tide_ws.py#L3663-L3732)
...
### 状态持久化机制
- 状态文件
  - 文件名：TIDE_STATE_FILE（默认 .tide_state.json）
...
- 状态文件路径
  - TIDE_STATE_FILE：状态文件路径（默认 .tide_state.json）
- 其他相关配置
...
- [tide_ws.py:126-141](file://tide_ws.py#L126-L141)
...
## 结论
Tide 的状态同步通过“文件增量读取 + 事件解析 + 去重节流 + 卡片回写”的闭环，实现了 Codex Desktop 会话的实时可视化与协作反馈。配合可靠的状态持久化与严格的并发控制，系统在稳定性与可维护性方面具备良好表现。建议在生产环境中合理设置轮询间隔与日志级别，并关注会话文件权限与 Lark API 的可用性。

## 附录
- 相关环境变量与默认值
  - TIDE_STATE_FILE：.tide_state.json
...
章节来源
- [README.md:413-428](file://README.md#L413-L428)
- [tide_ws.py:62-74](file://tide_ws.py#L62-L74)
- [tide_ws.py:126-141](file://tide_ws.py#L126-L141)