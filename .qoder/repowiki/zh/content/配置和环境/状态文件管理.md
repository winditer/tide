...
## 简介
本文件系统性阐述 Lark2Agent 的状态文件管理系统，重点围绕 `.lark2agent_state.json` 的结构、用途、生命周期管理与持久化策略。该状态文件承载以下关键信息：
- 已知聊天室记录（chats）
...
## 项目结构
- 状态文件位置：默认位于工作目录下的 `.lark2agent_state.json`，可通过环境变量 `LARK2AGENT_STATE_FILE` 自定义。
- 状态文件作用域：
...
- [lark2agent_ws.py:2028-2057](file://lark2agent_ws.py#L2028-L2057)
- [lark2agent_ws.py:909-953](file://lark2agent_ws.py#L909-L953)

**章节来源**
- [README.md:418-418](file://README.md#L418-L418)
- [lark2agent_ws.py:126-126](file://lark2agent_ws.py#L126-L126)
...
- [lark2agent_ws.py:2028-2057](file://lark2agent_ws.py#L2028-L2057)
- [lark2agent_ws.py:909-953](file://lark2agent_ws.py#L909-L953)
- [lark2agent_ws.py:956-980](file://lark2agent_ws.py#L956-L980)
...
Init->>Load : 读取 .lark2agent_state.json
...
- 文件位置与默认值
  ...
  - 可通过环境变量 `LARK2AGENT_STATE_FILE` 自定义
- 结构组成
...
- [lark2agent_ws.py:372-385](file://lark2agent_ws.py#L372-L385)
- [lark2agent_ws.py:343-369](file://lark2agent_ws.py#L343-L369)
- [lark2agent_ws.py:983-1014](file://lark2agent_ws.py#L983-L1014)
- [lark2agent_ws.py:1152-1157](file://lark2agent_ws.py#L1152-L1157)
...
- 查询与过滤
  ...
  - `LARK2AGENT_SHOW_ARCHIVED` 控制查询结果是否包含归档项
- 分类配置
  - `classification_state()` 提供分类配置访问入口
  - `marked_project_paths()`、`marked_ordinary_sessions()` 提供分类集合

**章节来源**
- [lark2agent_ws.py:2135-2164](file://lark2agent_ws.py#L2135-L2164)
- [lark2agent_ws.py:2677-2684](file://lark2agent_ws.py#L2677-L2684)
- [lark2agent_ws.py:2028-2057](file://lark2agent_ws.py#L2028-L2057)
...
**图表来源**
- [lark2agent_ws.py:1045-1071](file://lark2agent_ws.py#L1045-L1071)
- [lark2agent_ws.py:1074-1107](file://lark2agent_ws.py#L1074-L1107)
...
- [lark2agent_ws.py:1110-1149](file://lark2agent_ws.py#L1110-L1149)
- [lark2agent_ws.py:1152-1172](file://lark2agent_ws.py#L1152-L1172)

### 备份与迁移策略
- 备份
  - 建议在修改配置或升级前复制状态文件：`cp .lark2agent_state.json .lark2agent_state.json.bak`
- 迁移
...
**章节来源**
- [lark2agent_ws.py:869-891](file://lark2agent_ws.py#L869-L891)
- [lark2agent_ws.py:1074-1081](file://lark2agent_ws.py#L1074-L1081)
...
## 结论
Lark2Agent 的状态文件管理系统通过 JSON 文件实现了运行时状态的可靠持久化，涵盖聊天室运行时、Plan/子任务、归档与分类、消息引用等关键领域。其设计强调安全性（权限控制）、可靠性（原子替换）与可恢复性（重启后状态恢复）。遵循本文档的备份与迁移策略，可在升级与维护过程中最大限度保障业务连续性。
...
### 状态文件格式规范
- 文件名：`.lark2agent_state.json`
- 默认位置：工作目录
- 可配置项：`LARK2AGENT_STATE_FILE`
- 结构字段
